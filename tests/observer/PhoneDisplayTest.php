...
final class PhoneDisplayTest extends TestCase
{
    ...
    private PhoneDisplay $objPhoneDisplay;

    public function setUp(): void
    {
        $this->objWeatherStation = new WeatherStation();
        $this->objPhoneDisplay = new PhoneDisplay($this->objWeatherStation);

        $this->objWeatherStation->add($this->objPhoneDisplay);
    }
    ...
    public function testDisplayIsUpdatedAfterNotify(): void
    {
        ...
        $this->assertSame(
            'PhoneDisplay display: T 1.0, H 2.0, P 3.0<br>',
            $this->objPhoneDisplay->display()
        );
    }
    ...
    public function testDisplayValuesEqualToZeroWhenNoDataIsDefined(): void
    {
        ...
        $this->assertSame(
            'PhoneDisplay display: T 0.0, H 0.0, P 0.0<br>',
            $this->objPhoneDisplay->display()
        );
    }
}
